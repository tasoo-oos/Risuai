export const languageChineseTraditional = {
    ...
    "help": {
        ...
        "showModelInSidebar": "在側邊欄中顯示當前 AI 模型名稱，方便快速查看。",
        "showPresetInSidebar": "在側邊欄中顯示當前啟用的提示詞預設名稱，方便快速查看。",
        "showPersonaInSidebar": "在側邊欄中顯示當前啟用的人設名稱，方便快速查看。",
    ...
    "setup": {
        ...
        "setupMessageOption2Desc": "推薦進階使用者選用。",
    ...
    "updatePopupDesc": "新版本 <b>v{{latest}}</b> 已可用。（當前版本：v{{current}}）",
    ...
    "fetchLogConsent": (name: string) => `外掛 ${name} 正在請求存取記錄，此操作可能暴露敏感資訊。是否允許？`,
    "getFullDatabaseConsent": (name: string) => `外掛 ${name} 正在請求存取完整資料庫，此操作可能暴露敏感資訊。是否允許？`,
    "mainDomAccessConsent": (name: string) => `外掛 ${name} 正在請求存取主文件，此操作可能暴露敏感資訊。是否允許？`,
    "replacerPermissionConsent": (name: string) => `外掛 ${name} 正在請求替換對話內容的權限，此操作可能被用於操縱對話。是否允許？`,
    "providerPermissionConsent": (name: string) => `外掛 ${name} 正在請求存取提供商的權限，此操作可能允許未授權的 API 呼叫。是否允許？`,
    "sendChatConsent": (name: string) => `外掛 ${name} 正在請求以您的名義發送對話訊息的權限，這將觸發 AI 回應。是否允許？`,
    ...
    "serverBackupHeader": "NodeOnly 伺服器備份",
    "serverBackupDesc": "直接在安裝 NodeOnly 的裝置（伺服器）上儲存與還原備份檔案，無需下載。",
    ...
    "togglePresetFilterAll": "全部",
    "togglePresetFilterCurrent": "當前提示詞",
    "togglePresetNoPromptPreset": "無預設",
    "togglePresetEmptyFiltered": "當前提示詞預設沒有切換預設。",
    "togglePresetApplyConfirm": "當前的切換設定將被覆寫。確定要套用嗎？",
    "togglePresetMismatchConfirm": "此切換預設與當前的預設提示詞不同，套用後可能發生不相容的問題。仍要繼續嗎？",
    "togglePresetSaveNew": "儲存為新預設",
    "togglePresetOverwrite": "覆寫",
    "togglePresetOverwriteConfirm": (name: string) => `以當前切換值覆寫「${name}」？`,
    ...
    "importSaveFolderHeader": "將存檔載入至 NodeOnly",
    ...
    "remoteAccess": "遠端存取",
    "remoteAccessDesc": "透過遠端存取連結，您可以從其他裝置連接至此 NodeOnly 伺服器。",
    "remoteAccessOpen": "開啟遠端存取",
    "remoteAccessClose": "關閉遠端存取",
    "remoteAccessCloseConfirm": "關閉遠端存取？連結將會失效。",
    "remoteAccessDownloading": "正在下載 cloudflare...",
    ...
    "remoteAccessQrHint": "掃描 QR 碼以連接",
    "remoteAccessWarning": "**切勿將 QR 碼或連結分享給他人。**持有連結者將能自由存取您的伺服器。若不慎外洩，請立即關閉連線並重新生成新的連結。",
    "remoteAccessInfo": "關閉遠端存取或重啟伺服器時，連結將立即失效並於下次生成新連結。關閉此頁面或瀏覽器不會影響目前的連線。",
